...
{!!
	Form::open([
		'url' => route('extranet.admin.massmail.send'),
		'method' => 'POST',
...
<div class="page-bar">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="{{route('extranet.admin.offers.index')}}" class="btn btn-default">
                    <i class="fa fa-angle-left"></i>
                </a>

                <h1>
                    <i class="fa fa-reorder"></i> {{ Lang::get('extranet::settings.massmail') }}
                </h1>
...
<div class="container rightbar-page">
	...
	<div class="sidebar">
		...
		@foreach([
			Modules\Extranet\Entities\Offers\Candidate::TYPE_NORMAL,
			Modules\Extranet\Entities\Offers\Candidate::TYPE_INTERIM
		] as $name)
		{!!
			Form::checkbox('recipients[]', $name, old('recipients[' . $name . ']') ? true : false)
		!!}

		{{ $name }} ({{ Modules\Extranet\Entities\Offers\Candidate::countByType($name) }})
