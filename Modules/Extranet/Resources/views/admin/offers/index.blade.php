...
<div class="container leftbar-page">
  @include('extranet::admin.partials.offers-nav')
    <div class="col-xs-offset-2 col-xs-10 page-content">
        ...
        <a href="{{route('extranet.admin.offers.create')}}" class="pull-right btn btn-primary">
            Ajouter une offre
        </a>

        <h6 class="card-subtitle mb-2 text-muted">Retrouvez-ici l'ensemble des offres d'emploi</h6>

        <table class="table" id="table" data-url="{{ route("extranet.admin.offers.index.data") }}" style="width:100%">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Titre</th>
                    ...
                    <th data-filter="select" data-ajax="{{ route("extranet.admin.offers.index.data.recipients") }}">Destinataire interne</th>
                    <th id="actions-th"></th>
                </tr>
            </thead>
            <tfoot>
...
<script>
var routes = {
	data : '{{ route("extranet.admin.offers.index.data") }}',
    recipients : '{{ route("extranet.admin.offers.index.data.recipients") }}'
};
</script>
