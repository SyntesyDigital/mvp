...
{!!
    Form::open([
        'url' => isset($template)
            ? route('extranet.admin.emailstemplates.update', $template)
            : route('extranet.admin.emailstemplates.store'),
        'method' => 'POST'
    ])
!!}
...
<div class="page-bar">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="{{route('extranet.admin.emailstemplates.index')}}" class="btn btn-default">
                    <i class="fa fa-angle-left"></i>
                </a>

                <h1>
                    <i class="fa fa-reorder"></i> {{ Lang::get('extranet::settings.emails_templates') }}
                </h1>
