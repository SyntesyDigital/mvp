...
{!!
    Form::open([
        'url' => isset($customer)
            ? route('extranet.admin.customers.update', $customer)
            : route('extranet.admin.customers.store'),
        'method' => 'POST',
...
<div class="page-bar">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <a href="{{route('extranet.admin.customers.index')}}" class="btn btn-default"> <i class="fa fa-angle-left"></i> </a>
            ...
            @if(isset($customer))
                {{-- <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        {!!
                            Form::open([
                                'url' => route('extranet.admin.customers.delete', $customer->id),
                                'method' => 'POST',
...
<div class="container rightbar-page">
    <div class="col-md-9 page-content">
        @foreach(config('customers.form.left') as $node)
            @include('extranet::admin.partials.form.node', [
              'node' => $node,
...
@push('javascripts')
{{ Html::script('modules/extranet/js/admin/customer_contacts/customer_contactslist.js') }}
{{ Html::script('modules/extranet/js/admin/customers/customersform.js') }}
<script>
