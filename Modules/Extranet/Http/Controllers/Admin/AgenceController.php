...
use Modules\Extranet\Http\Requests\Agence\AgenceRequest;
use Modules\Extranet\Http\Requests\Agence\CreateFileRequest;
use Modules\Extranet\Jobs\Agence\CreateAgence;
use Modules\Extranet\Jobs\Agence\CreateFile;
use Modules\Extranet\Jobs\Agence\DeleteAgence;
use Modules\Extranet\Jobs\Agence\UpdateAgence;
use Modules\Extranet\Entities\Agence;
/*

use Modules\Extranet\Jobs\Tags\UpdateAgenceTags;
*/
use Modules\Extranet\Repositories\AgenceRepository;
...
class AgenceController extends Controller
{
    ...
    {
        return view('extranet::admin.agences.index');
    }
    ...
    {
        return view('extranet::admin.agences.form');
    }
