...
//use Modules\Extranet\Http\Requests\Admin\SendTagRequest;
//use Modules\Extranet\Jobs\SendTag;
...
use Modules\Extranet\Jobs\Tags\CreateTag;
use Modules\Extranet\Jobs\Tags\UpdateTag;
use Modules\Extranet\Jobs\Tags\DeleteTag;
use Modules\Extranet\Entities\Tag;

use Modules\Extranet\Repositories\TagRepository;
...
class TagController extends Controller
{
    ...
    {
        return view('extranet::admin.tags.index');
    }
    ...
    {
        return view('extranet::admin.tags.form');
    }
    ...
    public function update(Tag $tag, UpdateTagRequest $request)
    {
        ...
        return redirect()->route('extranet.admin.tags.show', $tag);
    }
    ...
    public function store(CreateTagRequest $request)
    {
        ...
        return redirect()->route('extranet.admin.tags.create')->withInput();
    }
