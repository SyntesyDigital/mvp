...
namespace Modules\Extranet\Entities\Offers;

use App\Models\User;
use Modules\Extranet\Presenters\DatePresenter;
use Auth;
use Cache;
use Geocoder\Geocoder;
use Illuminate\Database\Eloquent\Model;

use Modules\Extranet\Traits\FormFieldsEntity;
...
class Offer extends Model
{
    ...
    public $fieldModel = 'Modules\Extranet\Entities\Offers\OfferField';
    ...
    {
        return $this->hasOne('Modules\Extranet\Entities\Agence', 'id', 'agence_id');
    }


    public function tags()
    {
        return $this->belongsToMany('Modules\Extranet\Entities\Tag', 'offers_tags');
    }

    public function applications()
    {
        return $this->hasMany('Modules\Extranet\Entities\Offers\Application');
    }

    public function alerts()
    {
        return $this->hasMany('Modules\Extranet\Entities\Offers\AlertCandidate');
    }

    public function customer()
    {
        return $this->belongsTo('Modules\Extranet\Entities\Customer');
    }

    public function customer_contact()
    {
        return $this->belongsTo('Modules\Extranet\Entities\CustomerContact', 'customer_contact_id');
    }
