...
class ApplicationRepository extends BaseRepository
{
    ...
    {
        return "Modules\\Extranet\\Entities\\Offers\Application";
    }
        ...
        return Datatables::eloquent($applications)
            ...
            ->addColumn('status', function ($item) {
                return Form::select('status', $item->getStatus(), $item->status, [
                    'data-url' => route('extranet.admin.applications.spontaneous.update.status'),
                    'data-id' => $item->id,
            ...
            ->addColumn('action', function ($item) {
                return '
                    <a title="'.Lang::get("architect::datatables.view_candidate").'" href="'.route('extranet.admin.candidates.show', $item->candidate->user).'" class="btn btn-link"><i class="fa fa-user"></i></a> &nbsp;
                    <a title="'.Lang::get("architect::datatables.delete").'" href="#" class="btn btn-link text-danger" data-toogle="delete" data-ajax="'.route('extranet.admin.applications.delete', $item).'" data-confirm-message="Êtes-vous sûr de vouloir supprimer cette candidature ?"><i class="fa fa-trash"></i></a>
                ';
            })
    ...
    public function getDatatable()
    {
        ...
        return Datatables::eloquent($applications)
            ...
            ->addColumn('action', function ($item) {
                return '
                    <a title="'.Lang::get("architect::datatables.process").'" href="'.route('extranet.admin.offer.applications.show', $item->offer_id).'" class="btn btn-link"><i class="fa fa-pencil"></i></a> &nbsp;
                    <a title="'.Lang::get("architect::datatables.view_profile").'" href="'.route('extranet.admin.candidates.show', $item->candidate->user).'" class="btn btn-link"><i class="fa fa-user"></i></a> &nbsp;
                    <a title="'.Lang::get("architect::datatables.delete").'" href="#" class="btn btn-link text-danger" data-ajax="'.route('extranet.admin.applications.delete', $item).'" data-toogle="delete" data-confirm-message="Êtes-vous sûr de vouloir supprimer cette candidature ?"><i class="fa fa-trash"></i></a>
                ';
            })
