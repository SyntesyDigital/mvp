...
class CustomerRepository extends BaseRepository
{
    ...
    {
        return "Modules\\Extranet\\Entities\Customer";
    }
    ...
    public function getDatatableData()
    {
        ...
        return Datatables::of($results)
            ...
            ->addColumn('action', function ($customer) {
                return '<a href="'.route('extranet.admin.customers.show', $customer).'" class="btn btn-sm btn-success pull-right">Modifier</a>';
            })
        ->make(true);
    }
}
