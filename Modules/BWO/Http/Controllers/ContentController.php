...
use Modules\BWO\Adapters\PageBuilderAdapter;
use Modules\BWO\Adapters\FieldsAdapter;
...
class ContentController extends Controller
{
    ...
    private function renderTypology($request,$content) {
        ...
        return view('bwo::contents.'.strtolower($content->typology->name),$data);
    }
