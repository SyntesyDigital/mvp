...
class TypologyContainer extends Component {
  ...
  handleOpenSettings(fieldId) {
    ...
    TweenMax.to($("#settings-modal"),0.5,{opacity:1,ease:Power2.easeInOut});
  ...
  handleModalClose(e) {
    ...
    TweenMax.to($("#settings-modal"),0.5,{display:"none",opacity:0,ease:Power2.easeInOut,onComplete:function(){
      self.setState({
        settingsField : null,
        fields : fields
      })
