    ...
    return this.state.items.map((item, key) =>
      <div className="typology-field" key={key}>
        ...
        <div className="field-actions">
          <a href={'/'+item.url.replace('public','storage')+'/'+item.stored_filename} target="_blank" className=""> <i className="fa fa-download"></i>  </a> &nbsp;
...
if (document.getElementById('candidate-documents')) {
    ...
    ReactDOM.render(<CandidateDocuments config={config} />, document.getElementById('candidate-documents'));
}
