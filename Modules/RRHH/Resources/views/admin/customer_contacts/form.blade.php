                    ...
                    <div class="form-group">
                        ...
                        <div class="radio" style="display: inline; margin-left:20px;">
                            <label style="font-size: .8em">
                                 <input type="radio"  name="title"  value="{{ App\Models\CustomerContact::TITLE_MALE }}" {{isset($customer_contact) && $customer_contact->title == App\Models\CustomerContact::TITLE_MALE  ?'checked':'' }}>Monsieur
                            </label>
                            <label style="font-size: .8em">
                                <input type="radio" name="title" value="{{ App\Models\CustomerContact::TITLE_FEMALE }}" {{isset($customer_contact) && $customer_contact->title == App\Models\CustomerContact::TITLE_FEMALE  ?'checked':'' }}>Madame
                            </label>
                        </div>
                    </div>
