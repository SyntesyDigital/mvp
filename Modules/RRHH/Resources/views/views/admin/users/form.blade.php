                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control" >
                            <option value="{{Modules\RRHH\Entities\User::STATUS_ACTIVE}}" @if(isset($user)) @if($user->status == Modules\RRHH\Entities\User::STATUS_ACTIVE) selected @endif @endif>Actif</option>
                            <option value="{{Modules\RRHH\Entities\User::STATUS_INACTIVE}}" @if(isset($user)) @if($user->status == Modules\RRHH\Entities\User::STATUS_INACTIVE) selected @endif @endif>Désactivé</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="agence">Agence</label>
                         {!!
                            Form::select('agence',
                                Modules\RRHH\Entities\Agence::pluck('name', 'id'),
                    ...
                    <input type="hidden" name="old_status" id="old_status" value="{{ isset( $user) && $user->status == Modules\RRHH\Entities\User::STATUS_ACTIVE ? Modules\RRHH\Entities\User::STATUS_ACTIVE:Modules\RRHH\Entities\User::STATUS_INACTIVE}}" />
...
@push('javascripts')
    ...
    <script>
       var inactive_value = '{{Modules\RRHH\Entities\User::STATUS_INACTIVE}}';
    </script>
