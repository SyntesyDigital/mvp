                              ...
                              {{ csrf_field() }}
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <img class="loader" id="loginLoader" src="{{asset('images/loader.gif')}}" />
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <form role="form" method="POST" action="">
                              ...
                              <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <img class="loader" id="regLoader" src="{{asset('images/loader.gif')}}" />
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <form role="form" id="cv-form" method="POST" action="{{ route('candidate.addcv') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <img class="loader" id="upload-loader" src="{{asset('images/loader.gif')}}" />
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="modal-body">
                                <h3>Est vous sur de vouloir postuler?</h3>
                                 <div class="row">
                                    ...
                                    <img class="loader applyLoader" src="{{asset('images/loader.gif')}}" />
                                </div>
                        </div>
                    </div>
                </div>
