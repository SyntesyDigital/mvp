      ...
      <div class="row">
        ...
        <div id="carousel-full" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active"><img src="modules/turisme/images/img-big.png" alt="First slide image" class="center-block">
            ...
            <div class="item"><img src="modules/turisme/images/img-big.png" alt="Second slide image" class="center-block">
              <div class="carousel-caption">
                <h3>Second slide Heading</h3>
                <p>Second slide Caption</p>
              </div>
            </div>
            <div class="item"><img src="modules/turisme/images/img-big.png" alt="Third slide image" class="center-block">
              <div class="carousel-caption">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <li class="col-5">
            <div class="promo-image-text">
              <p class="image"><img src="modules/turisme/images/idees-per-a-reportatges.png" width="73" height="54" alt=""/></p>
              <p class="link"><a href="">Idees per a reportatges</a>
            </div>
            </li>
          <li class="col-5">
            <div class="promo-image-text">
              <p class="image"><img src="modules/turisme/images/estudis-i-estadistiques.png" width="73" height="54" alt=""/></p>
              <p class="link"><a href="">Estudis i estadístiques</a>
            </div>
          </li>
          <li class="col-5">
            <div class="promo-image-text">
              <p class="image"><img src="modules/turisme/images/imatges-videos-i-cartografia.png" width="73" height="54" alt=""/></p>
              <p class="link"><a href="">Imatges, vídeos i cartografia</a>
            </div>
          </li>
          <li class="col-5">
            <div class="promo-image-text">
              <p class="image"><img src="modules/turisme/images/publicacions-turistiques-i-apps.png" width="73" height="54" alt=""/></p>
              <p class="link"><a href="">Publicacions turístiques i apps</a>
            </div>
          </li>
          <li class="col-5">
            <div class="promo-image-text">
              <p class="image"><img src="modules/turisme/images/calendri-de-congresos.png" width="73" height="54" alt=""/></p>
      	...
      	<div class="col-md-4 col-sm-6 col-xs-12">
      		<div class="widget slider promo trade">
      		 <h3>Per què Barcelona?</h3>
				  ...
				  <div class="carousel-inner" role="listbox">
					<div class="item active"><img src="modules/turisme/images/img-medium.png" alt="First slide image" class="center-block">
					  <div class="carousel-caption">

						  <p><a href="">1-Lorem ipsum dolor sit amet, consectetur adipiscing elit. </a></p>
					  </div>
					</div>
					<div class="item"><img src="modules/turisme/images/img-medium.png" alt="Third slide image" class="center-block">
					  <div class="carousel-caption">
						<p><a href="">2-Donec ut dapibus est.tetur adipiscing elit. </a></p>
					  </div>
					</div>
					<div class="item"><img src="modules/turisme/images/img-medium.png" alt="Second slide image" class="center-block">
					  <div class="carousel-caption">
      ...
      <div class="row">
        ...
        <div class="col-md-4  col-sm-4 col-xs-12">
          <div class="banner banner-image">
            <p class="image"><span class="promo-text mediac"><img src="modules/turisme/images/img-medium.png"  alt=""/></span></p>
            </div>
        </div>
      </div>
      </div>
