...
export default class CandidateDocuments extends Component {
  ...
  {
      toastr.success('Action realisée avec succès !');
      _this.loadDocs();
  }
            ...
            <div className="row">
              <div className="col-md-4 image-col">
                ...
                <div className="image no-selected docs-dropfiles">
                  <p align="center">
                    <strong>Glisser un fichier ou</strong> <br />
                    <a href="#" className="btn btn-default"><i className="fa fa-upload"></i> déposer le fichier </a>
                  </p>
                </div>
...
if (document.getElementById('candidate_documents')) {
    var element = document.getElementById('candidate_documents');
    var config = element.getAttribute('config');

    ReactDOM.render(<CandidateDocuments config={config} />, document.getElementById('candidate_documents'));
}
