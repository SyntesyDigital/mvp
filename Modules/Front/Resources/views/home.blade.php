@extends('front::layouts.master', [
  'htmlTitle' => 'Front, votre agence d\'intérim tertiaire à Paris 75012',
  'metaDescription' => 'Front Paris, agence pour l\'emploi tertiaire. Assistanat, secrétariat, comptabilité, contrôle gestion, fonctions support… Intérim, CDD et CDI 75, 92, 93, 94.',
...
@section('content')
  ...
  <div class="banner home-banner" style="background-image:url('{{asset('modules/front/images/banners/'.$imageNum.'.jpg')}}')">
  ...
  <div class="gray-information-container">
    <div class="horizontal-inner-container">
      ...
      <div class="col-md-6 home-square p-l-10">
        ...
        <p>Bienvenue sur le site Front. Installée à Paris 12e, notre agence pour l'emploi est spécialisée dans les offres du secteur tertiare. Assistanat, secrétariat, comptabilité, contrôle de gestion... nos offres d'emploi concernent aussi bien des missions d'intérim que des recrutements en CDD et CDI sur Paris (75) et la petite couronne (92, 93 et 94).</p>
  ...
  <div class="doble-bk-information-container">
      <div class="horizontal-inner-container">
        ...
        <div class="col-md-6 home-square home-square-gray p-l-10">
          ...
          <p>Vous recherchez un emploi dans le secteur tertiaire sur Paris et  en banlieue ? Déposez votre candidature sur le site de Front, notre équipe, chargée du recrutement, analysera votre profil professionnel avec le plus grand intérêt.</p>
          <div class="centered">
