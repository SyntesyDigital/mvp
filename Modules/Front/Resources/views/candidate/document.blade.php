	...
	<div class="candidate-container">
			...
			<div class="col-xs-12">
				...
				<div
					...
					config="{{ base64_encode(json_encode([
							'type' => 'ajax',
							'route' => route('extranet.admin.candidates.documents.data',Auth::user()->candidate()->first())
						], true))}}"
				></div>
		...
		<div class="row">
			<div class="col-xs-12">
				...
				@if(Auth::user()->candidate->type != \Modules\Extranet\Entities\Offers\Candidate::TYPE_INTERIM)
				...
				@else
					...
					@php
						$list = Modules\Extranet\Entities\Tools\SiteList::where('identifier', 'doclist')->first();
