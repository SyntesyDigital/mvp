			...
			@foreach ($related_offers as $o)
				<div class="col-md-4 offer-container">
					<div class="offer-box" style="background-image:url('{{asset('images/offer-bk.jpg')}}')">
						...
						<p><i class="fa fa-star"></i> {{ Modules\Extranet\Entities\Tools\SiteList::getListValue($o->job_1, 'jobs1') }}</p>
						<p><i class="fa fa-file-o"></i> {{ Modules\Extranet\Entities\Tools\SiteList::getListValue($o->contract, 'contracts') }}</p>
						...
						<a href="{{ route('offer.show', [
								'job_1' => str_slug(Modules\Extranet\Entities\Tools\SiteList::getListValue($o->job_1, 'jobs1'), '-'),
								'id' => $o->id
