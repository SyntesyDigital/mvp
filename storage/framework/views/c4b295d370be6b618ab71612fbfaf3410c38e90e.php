            ...
            <div class="card">
				<div class="card-body">
                    ...
                    <h3 class="card-title">Listes de formulaire
                        <a href="<?php echo e(route('rrhh.admin.sitelists.create')); ?>" class="pull-right btn btn-primary">
                            Ajouter une liste
                        </a>
                    </h3>
                    ...
                    <table class="table" id="crosslinks-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('rrhh.admin.sitelists.show', $sl->id)); ?>">
                                    <?php echo e($sl->name); ?>
                            ...
                            <td>
                                <a href="<?php echo e(route('rrhh.admin.sitelists.show', $sl->id)); ?>" class="btn btn-sm btn-success pull-right">Modifier</a>
                            </td>
                        </tr>
