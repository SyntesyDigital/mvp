...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
        ...
        <link rel="stylesheet" media="all" href="<?php echo e(asset('modules/extranet/css/app.css')); ?>" />
        ...
        <script>
          $(function(){
            ...
            <?php if(Session::has('notify_error')): ?>
                error += "- <?php echo e(Session::get('notify_error')); ?><br/>";
            <?php endif; ?>
            ...
            <?php if(Session::has('notify_success')): ?>
              toastr.success("<?php echo e(Session::get('notify_success')); ?>", 'Success', {timeOut: 3000});
            <?php endif; ?>
        ...
        <script src="<?php echo e(asset('modules/extranet/js/app.js')); ?>" defer></script>
