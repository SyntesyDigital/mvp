    ...
    <div class="offers-container">
      <div class="horizontal-inner-container blog-container">
        ...
        <div class="posts-list">
          <div class="col-md-6">
            <div class="post-box">
                <div class="image" style="background-image:url('<?php echo e(asset('modules/bwo/images/post.jpg')); ?>')"></div>
                <div class="title">
                  TITRE ACTUALITÉ
                </div>
                <p>Le 16/11/2018 - CATÉGORIE</p>
                <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras placerat egestas fringilla. Donec quis convallis metus.Lorem ipsum dolor sit amet, consectetur adipiscing elit...<a href="<?php echo e(route('post')); ?>" class="detail" >Lire la suite</a></p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="post-box">
