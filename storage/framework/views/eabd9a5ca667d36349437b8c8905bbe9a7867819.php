...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php echo e(App::getLocale()); ?>">
    <head>
        ...
        <title><?php echo e(isset($title) ? $title : Lang::get("turisme::messages.seo.title")); ?></title>
        ...
        <link href="<?php echo e(asset('modules/turisme/css/app.css')); ?>" rel="stylesheet" type="text/css" />

        <!-- Fonts -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css" integrity="sha384-XdYbMnZ/QjLh6iI4ogqCTaIjrFk87ip+ekIjefZch0Y+PvJ8CDYtEs1ipDmPorQ+" crossorigin="anonymous">

        <!--
        <link href="<?php echo e(asset('modules/turisme/css/turisme.css')); ?>" rel="stylesheet" type="text/css" />
        -->
    ...
    <body class="<?php echo e(isset($mainClass) ? $mainClass : ''); ?>">
        ...
        <?php echo $__env->make('turisme::partials.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        <?php echo $__env->yieldContent('content'); ?>

        <!-- Footer blade important to add JavasCript variables from Controller -->
        <?php echo $__env->make('turisme::partials.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <script>
        ...
        <!-- Language -->
        <script type="text/javascript" src="<?php echo e(asset('modules/turisme/js/lang.dist.js')); ?>" ></script>
        <script>
            Lang.setLocale('<?php echo e(App::getLocale()); ?>');
        </script>

        <script type="text/javascript" src="<?php echo e(asset('modules/turisme/js/app.js')); ?>" ></script>
