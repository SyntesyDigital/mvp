...
<div class="container leftbar-page">
  ...
  <div class="col-xs-offset-2 col-xs-10 page-content">
    ...
    <h3 class="card-title"><?php echo e(Lang::get('architect::category.categories')); ?></h3>
    <a href="<?php echo e(route('categories.create')); ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> &nbsp; <?php echo e(Lang::get('architect::category.add')); ?></a>

    <div class="grid-items">
      <div class="row">
        <ol class='sortable-list'>
          <?php echo e(Lang::get('architect::category.loading')); ?>
...
<script>
  ...
  var routes = {
    showItem : '<?php echo e(route("categories.show",["id"=>":id"])); ?>',
    getData : '<?php echo e(route("categories.data")); ?>',
    deleteItem : '<?php echo e(route("categories.delete",["id"=>":id"])); ?>',
    updateOrder : '<?php echo e(route("categories.update-order")); ?>'
  };
  ...
  $(function(){
    ...
    $.getJSON('<?php echo e(route("categories.data")); ?>',function(data){
