app.sitelist = {
    ...
    drop: function(e){
        ...
        for (var i = 0; i < options.length; i++) {
            list_json.push({name: options[i].getElementsByClassName("input-name-option")[0].value, value: options[i].getElementsByClassName("input-value-option")[0].value});
        }
        this.parseJson();
    },
